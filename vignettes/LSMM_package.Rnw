...
Jingsi Ming, Mingwei Dai, Mingxuan Cai, Jin Liu, Can Yang,
LSMM: A statistical approach to integrating functional annotations with genome-wide association studies. 2017. Under review.
